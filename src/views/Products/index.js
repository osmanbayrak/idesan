...
class Products extends React.Component {
  ...
  render() {
    ...
    const products = {
      ...
      saclar: {
        text: '0,35 mm’den 10 mm’e kadar saç çeşitlerimiz mevcuttur. İstenilen özel ebatlarda saç flanş kesimi, oluk kıvırma ve lazer kesim işlemleriniz yapılmaktadır.',
        cards: [
    ...
    return (
      <Col md={{span: 24}} xs={24}>
        ...
        <Divider style={{color: 'darkgray', height: '2px'}} plain><h1>ÜRÜN PORTFÖYÜ</h1></Divider>
        <Tabs defaultActiveKey={"profiller"} onChange={this.callback} style={{textAlign: 'center', background: 'ghostwhite', borderRadius: '9px', paddingTop: '11px'}}>
          ...
          <Tabs.TabPane tab={<span style={{fontSize: '16px'}}>HADDE DEMİRLER</span>} key="hadde_demirler">
            <Row style={{marginTop: '20px'}} gutter={24}>
